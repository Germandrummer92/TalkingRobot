...
//		  Process phoenix = rt2.exec("tcsh " + runParse + " < input", null, new File("resources/nlu/Phoenix/TalkingRobot"));
		  ...
		  ProcessBuilder phoenixBuilder = new ProcessBuilder("/bin/tcsh", "run_parse_approval");
		  phoenixBuilder.directory(new File("resources/nlu/Phoenix/TalkingRobot"));
		  phoenixBuilder.redirectInput(new File("resources/nlu/Phoenix/TalkingRobot/Approval/input"));
...
public static void main(String[] args) {
	...
	pa.operatePhoenix("Hello,  can you tell me how to make Spaghetti?", null, 1, new File("resources/nlu/Phoenix/TalkingRobot/Approval"));
}
}